...
const fr = {
  ...
  export: {
    score_label: 'Score',
    level_label: 'Niveau',
    courage_message: 'Courage, vaillant héros !',
  ...
  bosses: {
    ...
    crazy_chicken: {
      name: '🐔 Le Poulet Fou',
      intro: 'Un poulet panique dans tous les sens... Les fausses peurs te rendent fou et te paralysent !',
      phase_1: '😰 "Car Dieu ne nous a pas donné un esprit de timidité, mais un esprit de force, d\'amour et de sagesse." (2 Timothée 1:7)\n\nLes FAUSSES PEURS SUBJECTIVES : "Et si...?", "Peut-être que...", "J\'ai peur que..." - Des peurs IMAGINAIRES qui te FREINENT !',
      phase_2: '🧠 "Ne vous inquiétez de rien ; mais en toute chose faites connaître vos besoins à Dieu." (Philippiens 4:6)\n\nLes SCÉNARIOS CATASTROPHES dans ta tête, les PEURS IRRATIONNELLES qui te rendent fou ! STOP !',
      phase_3: '✨ "Car Dieu est celui qui produit en vous le vouloir et le faire, selon son bon plaisir." (Philippiens 2:13)\n\nCes peurs SUBJECTIVES ne sont PAS LA RÉALITÉ ! Dieu t\'a donné la SAGESSE, pas la FOLIE !',
      defeated: '🦅 VICTOIRE SUR LES FAUSSES PEURS !\n\n"Ne crains rien, car je suis avec toi." (Ésaïe 41:10)\n\nTu as vaincu les peurs imaginaires ! Tu marches maintenant dans la sagesse, pas dans la folie.',
      wisdom: 'Le poulet fou représente les fausses peurs subjectives qui nous rendent fous : "Et si je rate ?", "Et si on me juge ?", "Et si je ne suis pas à la hauteur ?". Ces peurs imaginaires, ces scénarios catastrophes dans notre tête nous paralysent et nous freinent. Nous paniquons comme un poulet affolé pour des choses qui n\'existeront peut-être jamais ! La Bible dit : "Dieu ne nous a pas donné un esprit de timidité, mais de force, d\'amour et de sagesse." 95% de nos peurs ne se réalisent jamais. Ces peurs subjectives ne sont pas la réalité - ce sont des mensonges de l\'ennemi pour nous empêcher d\'avancer. "Ne vous inquiétez de rien" - Dieu nous appelle à remplacer les fausses peurs par la foi, la panique par la paix, les scénarios catastrophes par la confiance en Sa providence.'
    },
    grim_reaper: {
      name: '💀 La Faucheuse',
      ...
      phase_2: '✝️ "Jésus lui dit : Je suis la résurrection et la vie. Celui qui croit en moi vivra, quand même il serait mort." (Jean 11:25)\n\nLa vie triomphe toujours sur les ténèbres ! Chaque instant est une VICTOIRE !',
      phase_3: '🌟 "Enseigne-nous à bien compter nos jours, afin que nous appliquions notre cœur à la sagesse." (Psaume 90:12)\n\nPeu importe le temps qui reste - VIS PLEINEMENT ! Chaque jour est un CADEAU !',
      defeated: '🙏 VICTOIRE SUR LA MORT !\n\n"Il n\'y a donc maintenant aucune condamnation pour ceux qui sont en Jésus-Christ." (Romains 8:1)\n\nTu as vaincu la peur ! La vie éternelle t\'appartient par la grâce de Dieu.',
      wisdom: 'La mort n\'est pas une fin, mais une transformation. Par le Christ, nous passons de la vie terrestre à la vie éternelle. Peu importe le temps qui nous reste ou la manière dont on vit - le mieux c\'est de vivre chaque instant comme une victoire, chaque nouvelle année de plus comme un cadeau. Même dans la maladie, même dans l\'épreuve, l\'ESPÉRANCE et l\'OPTIMISME donnent des ailes et rendent l\'impossible souvent possible ! La Bible dit : "Enseigne-nous à bien compter nos jours, afin que nous appliquions notre cœur à la sagesse." Chaque jour est précieux. Chaque souffle est une grâce. La foi chrétienne nous enseigne que la mort a été vaincue à la Croix, et que l\'espérance de la résurrection illumine notre chemin. Vivons donc pleinement, avec joie et reconnaissance, car "ce jour est celui que l\'Éternel a fait : qu\'il soit pour nous un sujet d\'allégresse et de joie !" (Psaume 118:24)'
    },
    wall: {
